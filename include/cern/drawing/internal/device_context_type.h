#ifndef CERN_DRAWING_INTERNAL_DEVICE_CONTEXT_TYPE_H
#define CERN_DRAWING_INTERNAL_DEVICE_CONTEXT_TYPE_H 1

/**
 * @enum CernDeviceContextType
 * @brief Enumeration of device context types.
 */
typedef enum _CernDeviceContextType {
  /** Unknown device */
...
#endif /* CERN_DRAWING_INTERNAL_DEVICE_CONTEXT_TYPE_H */
